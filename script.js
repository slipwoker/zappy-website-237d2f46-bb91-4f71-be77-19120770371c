document.addEventListener('DOMContentLoaded', function() {
  ...
  if (phoneHeaderBtn) {
    phoneHeaderBtn.addEventListener('click', function() {
      var e=document.querySelectorAll('a[href^="tel:"]');var n=e.length>0?e[0].getAttribute("href").replace("tel:",""):"0544339627";window.location.href="tel:"+n
    });
  }
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
      ...
      "es": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור utiliza cookies para mejorar tu experiencia, analizar el uso del sitio y ayudar en nuestros esfuerzos de marketing.",
      ...
      "fr": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור utilise des cookies pour améliorer votre expérience, analyser l'utilisation du site et nous aider dans nos efforts marketing.",
      ...
      "de": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור verwendet Cookies, um Ihr Erlebnis zu verbessern, die Nutzung der Website zu analysieren und unsere Marketingbemühungen zu unterstützen.",
      ...
      "it": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור utilizza i cookie per migliorare la tua esperienza, analizzare l'utilizzo del sito e supportare le nostre attività di marketing.",
      ...
      "pt": {
        "consentModal": {
          "title": "Usamos cookies 🍪",
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור usa cookies para melhorar sua experiência, analisar o uso do site e auxiliar em nossos esforços de marketing.",
      ...
      "nl": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור gebruikt cookies om uw ervaring te verbeteren, het sitegebruik te analyseren en onze marketinginspanningen te ondersteunen.",
      ...
      "he": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
      ...
      "ar": {
        "consentModal": {
          ...
          "description": "يستخدم המרכז לגמילה ממיגרנות ברפואה סינית ודיקור ملفات تعريف الارتباط لتحسين تجربتك وتحليل استخدام الموقع والمساعدة في جهودنا التسويقية.",
      ...
      "tr": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור, deneyiminizi geliştirmek, site kullanımını analiz etmek ve pazarlama çalışmalarımıza yardımcı olmak için çerezler kullanır.",
      ...
      "ru": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור использует файлы cookie для улучшения вашего опыта, анализа использования сайта и поддержки наших маркетинговых усилий.",
      ...
      "zh": {
        "consentModal": {
          "title": "我们使用 Cookie 🍪",
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור 使用 Cookie 来改善您的体验、分析网站使用情况并协助我们的营销工作。",
          "acceptAllBtn": "全部接受",
      ...
      "ja": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקורは、お客様の体験向上、サイト利用状況の分析、マーケティング活動の支援のためにCookieを使用しています。",
          "acceptAllBtn": "すべて許可",
      ...
      "ko": {
        "consentModal": {
          "title": "쿠키를 사용합니다 🍪",
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור은(는) 경험 향상, 사이트 사용 분석 및 마케팅 활동 지원을 위해 쿠키를 사용합니다.",
          "acceptAllBtn": "모두 수락",
      ...
      "pl": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור używa plików cookie, aby poprawić Twoje wrażenia, analizować korzystanie z witryny i wspierać nasze działania marketingowe.",
      ...
      "uk": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור використовує файли cookie для покращення вашого досвіду, аналізу використання сайту та підтримки наших маркетингових зусиль.",
      ...
      "ro": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור folosește cookie-uri pentru a vă îmbunătăți experiența, a analiza utilizarea site-ului și a sprijini eforturile noastre de marketing.",
      ...
      "bg": {
        "consentModal": {
          ...
          "description": "המרכז לגמילה ממיגרנות ברפואה סינית ודיקור използва бисквитки, за да подобри вашето изживяване, да анализира използването на сайта и да подпомогне маркетинговите ни усилия.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '237d2f46-bb91-4f71-be77-19120770371c',
                    name: data.name || '',
                    email: data.email || '',
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '237d2f46-bb91-4f71-be77-19120770371c';
